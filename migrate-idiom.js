const data = [
  ...
  },
  {
    ...
    explanationPinyin:
      "Ānyì de shēnghuó huánjìng huò xiǎoqiǎo, wēnnuǎn, shūshì de chùsuǒ huò fángjiān.",
    ...
    exampleMeaning:
      "Anh trốn trong “tổ ấm” của mình và chẳng quan tâm đến điều gì.",
  ...
  },
  {
    ...
    examplePinyin:
      "Bǎi shénme jià zi, nǐ dé qīngxǐng yīxià le, nǐ yǐjīng bù zài shì lǐngdǎo le.",
    exampleMeaning:
      "Đừng tỏ vẻ kiêu ngạo nữa, anh cần nhớ rằng mình không còn là lãnh đạo.",
    arrange:
      "什么 / 架子 / 摆 / ，/ 你 / 得 / 清醒 / 一下了 / ，/ 你 / 已经 / 不再是 / 领导了 / 。/",
  },
  {
    simplified: "白眼狼",
    pinyin: "bái yǎn láng",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù bù tōng shìlǐ, shuōhuà suíbiàn, jǔzhǐ qīngfú de rén.",
  ...
  },
  {
    ...
    examplePinyin:
      "Bàn píng cù, zhèng yīnwèi bùmǎn, cái róngyì fāchū shēngyīn.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù néng qǐ dào bǎohù zuòyòng de rén huò shìwù (hán biǎnyì).",
    meaning:
      "Người hoặc vật có thể bảo vệ, nhưng mang hàm ý châm biếm hoặc khinh thường.",
    examples: "当地政府当了黑势力的保护伞，真让人气愤。",
    examplePinyin:
      "Dāngdì zhèngfǔ dāng le hēi shìlì de bǎo hù sǎn, zhēn ràng rén qìfèn.",
    exampleMeaning:
      "Chính quyền địa phương đã trở thành “ô dù” che chở cho các thế lực đen tối, thật khiến người ta tức giận.",
    arrange:
      "黑势力 / 当地政府 / 当了 / 的 / 保护伞 / ，/ 真 / 让人 / 气愤 / 。/",
  },
  {
    simplified: "爆冷门",
    pinyin: "bào lěng mén",
    explanation:
      "比喻突然出现人们意想不到的情况或结果。冷门，指赌博时很少有人下注的一门。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù dài biérén chéngdān guòcuò, zuìmíng, fàn zhǐ shòudào yuānwǎng.",
    ...
    exampleMeaning:
      "Tôi không bao giờ chịu làm “kẻ chịu tội thay” cho người khác.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù bèn de rén yīnggāi xiān xíngdòng. Chángyòng lái bǐyù zìjǐ.",
    meaning:
      "Biểu thị người ngu ngốc nên hành động trước. Thường được dùng để chỉ bản thân.\n\n",
    examples:
      "我的基础不好，就得笨鸟先飞嘛。\n我得笨鸟先飞，要不然，落后了怎么办?",
    examplePinyin:
  ...
  },
  {
    ...
    pinyin: "bù chénɡ qì",
    explanation:
      "不能成为有用的器物。后用以比喻不成才，没出息，没有发展前途或志气。也说“不成才”。",
    explanationPinyin:
  ...
  },
  {
    ...
    pinyin: "bú dònɡ wō",
    explanation:
      "比喻不离开原来的地方。窝: 鸟兽、昆虫住的地方，借指人体或物体所占的地方。",
    explanationPinyin:
      "bǐyù bù líkāi yuánlái de dìfāng. Wō: niǎoshòu, kūnchóng zhù de dìfāng, jièzhǐ réntǐ huò wùtǐ suǒ zhàn de dìfāng",
    meaning:
      "Không rời khỏi nơi cũ. “窝”ám chỉ nơi ở của động vật, cũng chỉ chỗ của con người hoặc vật thể.",
    examples:
      "他坐在电脑前炒股票，一坐两三个小时也不动窝。\n该做饭了，一家三口都在看电视，谁都不动窝。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "zhǐ jīngjì bù fánróng de jǐngxiàng, fànzhǐ shìyè bù xīngwàng",
    meaning:
      "Chỉ tình trạng kinh tế không phát triển, nói chung là công việc không thịnh vượng.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù bù chéngrèn duìfāng de chángchù huò lìliàng, bù pèifú huò bù fúcóng",
    meaning:
      "Không công nhận điểm mạnh hoặc năng lực của đối phương, không tôn trọng hoặc không phục tùng.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      'bù zhídé zhòngshì; bù yǐnrén zhùmù, yòu zuò "bù xiǎn yǎn"',
    meaning: "Không đáng chú ý; không nổi bật. Cũng gọi là “不显眼”.",
    examples:
      "这么一件不起眼的衣服，要五千块，太不值了。\n他很普通，在人群里一点儿也不起眼。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù guānxì àimèi, bù zhèngdàng, huòzhě bǐyù bù chúnjié, yǒu wūdiǎn",
  ...
  },
  {
    ...
    meaning:
      "Không thừa nhận, ví dụ không thừa nhận những điều đã nói hoặc đã làm.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      'bǐyù yányǔ, xíngwéi bù hé qínglǐ, yě shuō "bù chéng huà"',
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù cǎiqǔ yǔ duìfāng xiāngfǎn de xíngdòng, huò yǒuyì gǎo kuǎ duìfāng",
    meaning:
      "Hành động trái ngược với đối phương, hoặc cố tình làm sụp đổ đối phương.",
    examples:
  ...
  },
  {
    ...
    explanation:
      "京剧中的反派角色。指扮演反面的角色，对事情采取尖酸苛刻的态度。",
    explanationPinyin:
  ...
  },
  {
    ...
    meaning:
      "Phát biểu ý kiến hoàn toàn đối lập; thực hiện những hành động trái ngược.",
    examples:
      "你不要总是跟领导唱反调，没什么好处。\n孩子正处在叛逆期，什么都跟我唱反调。",
    examplePinyin:
  ...
  },
  {
    ...
    explanation:
      "就是装好人。比喻在批评或争斗中担当劝导、抚慰、缓冲等任务的角色。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanation:
      "比喻掩饰自己力量空虚、骗过对方的方法; 比喻某单位的人员全部或大部分不在; 形容肚子饿。",
    explanationPinyin:
    ...
    examplePinyin:
      "Kuài shàng cài ba, wǒ de dùzi yǐjīng zài chàng kōng chéng jì le. \n",
  ...
  },
  {
    ...
    examples:
      "我不怕大家说我炒冷饭,因为这件事没有得到解决，问题依然存在，所以我不得不再说一遍。\n",
    examplePinyin:
  ...
  },
  {
    ...
    exampleMeaning:
      "Đừng trở thành “kẻ bạc tình” như Trần Thế Mỹ, bỏ mặc cô ấy.",
  ...
  },
  {
    ...
    meaning:
      "Giữ hình thức bên ngoài để tạo ấn tượng. Cũng gọi là “撑门面”: làm bộ mặt.",
    examples: "到时候你一定要来哦，帮我撑撑场面。\n",
    examplePinyin:
      "dào shíhòu nǐ yīdìng yào lái ó, bāng wǒ chēng chēng chǎng miàn.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ bú fùchū rènhé dàijià ér zhànyǒu shìwù huò qiáncái.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù chuànmén shí, zhǔrén bù zàijiā, bèi jùjué jìnmén huò shòu qítā lěngyù",
    meaning:
      "Khi đến thăm mà chủ nhà không có nhà, bị từ chối vào hoặc bị đối xử lạnh nhạt.",
    examples: "他想去看女朋友，未来的丈母娘让他吃了闭门羹。\n",
    examplePinyin:
      "Tā xiǎng qù kàn nǚ péngyǒu, wèilái de zhàngmǔniáng ràng tā chīle bì mén gēng. \n",
    exampleMeaning:
      "Anh ấy muốn đi gặp bạn gái, nhưng mẹ vợ tương lai đã đóng cửa không cho vào. \n",
    arrange:
      "想去 / 他 /，/ 女朋友 / 吃了 / 吃了 / 闭门羹 / 的 / 让他 / 看 / 未来 / 丈母娘/。/\n",
  },
  {
    simplified: "吃不开",
    pinyin: "chī bu kāi",
    ...
    meaning:
      "Không nhận được sự chấp nhận hoặc chào đón bởi mọi người xung quanh.",
    examples:
  ...
  },
  {
    ...
    pinyin: "chī cù",
    explanation:
      "比喻因嫉妒而引起的不快情绪，形容爱嫉妒别人。多指因男女关系而妒忌、争吵。",
    explanationPinyin:
  ...
  },
  {
    ...
    examplePinyin:
      '"shì bùshì chī cuò yào le, zěnme lián wǒ dōu bù rènshí le?"',
    exampleMeaning:
      "Có phải anh uống nhầm thuốc không mà ngay cả tôi anh cũng không nhận ra?",
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù qǐyè bù lùn yíngkuī, gèrén bù fēn qínlǎn, quán yóu guójiā bāogān de bànfǎ",
    meaning:
  ...
  },
  {
    ...
    pinyin: "chī dú shí",
    explanation:
      "有东西自己一个人吃，不给别人。比喻有好处自己一个人享用，不与别人分享。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "jiùshí zhǐ bèi kònggào, shòu chǔfá huòzhě guān jìn jiānyù",
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù wéi guójiā gōngzuò, yīkào guójiā jǐyǔ xīnfèng shēnghuó",
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù yīlài yuányǒu de zhīshì, běnlǐng huò gōngláo guò rìzi, méiyǒu xīn de gòngxiàn",
    meaning:
      "Dựa vào kiến thức, khả năng hoặc công lao đã có để sống, không có đóng góp mới.",
    ...
    arrange:
      "革命 / 不要 /，/ 吃老本 /，/ 同志啊 / 立新功 /，/ 躺在 / 功劳簿 / 上 / 不要 / 嘛 / 要/。/\n",
  },
  {
    simplified: "吃枪药",
  ...
  },
  {
    ...
    explanation:
      "比喻没有东西吃，挨饿; 或者闲着没事干，没有收入。也叫喝西北风。",
    explanationPinyin:
  ...
  },
  {
    ...
    examples:
      "听说近来荧屏上几部古装帝王大戏收视均不理想，不如以前那么吃香了。\n",
    examplePinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "Jiàoliàn kàn tā shì ge miáozi, jīngcháng gěi tā chī xiǎo zào.",
    exampleMeaning:
      "Huấn luyện viên thấy anh ấy có tiềm năng nên thường cho tập riêng.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bù wéi rénzhī de rén, huò bù bèi biérén zhòngshì de rén.",
  ...
  },
  {
    ...
    examplePinyin:
      "Wǒ xǐhuān chànggē, yě xǐhuān zài jùhuì shàng biǎoxiàn yīxià, chū chū fēng tóu.\n ",
    exampleMeaning: "Tôi thích ca hát và thể hiện trong các buổi tụ tập.\n ",
    arrange:
      "喜欢 / 喜欢 / 我 / 唱歌 /，/ 聚会上 / 也 /，/ 出出风头 / 在 / 表现 / 一下/。/\n",
  },
  {
    simplified: "出花样",
    pinyin: "chū huā yàng",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù chòuwèixiāngtóu de rén liánhé zài yīqǐ. Yě shuō “chuān yītiáo kùzi”.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù wúshì jìlǜ, zhìdù, yuánzé de xiànzhì, zuò bù gāi zuò de shìqíng.",
    meaning:
  ...
  },
  {
    ...
    examplePinyin:
      "cái shíliù suì, shè shì wèi shēn, què chǎo zhe yào chuǎng jiāng hú, zhēn kěxiào.",
    exampleMeaning:
      "Mới 16 tuổi, chưa hiểu đời mà đã muốn “phiêu bạt giang hồ,” thật là buồn cười.",
    arrange:
      "十六岁 / 闯江湖 / 吵着 /，/ 涉世未深 /，/ 其实 / 真 /，/ 才 / 可笑 / 要 / 却/。/",
  },
  {
    simplified: "吹胡子瞪眼",
  ...
  },
  {
    ...
    examplePinyin:
      "Tā hěn míxìn, shēntǐ yòu bù hǎo, zuì pà cuī mìng pàn guān lái bǎ tā tí zǒu.",
    exampleMeaning:
      "Anh ấy rất mê tín và sức khỏe yếu, sợ nhất là “phán quan tử thần” đến lấy mạng.",
    arrange:
      "迷信 / 最怕 / 他 /，/ 催命判官 / 很 /，/ 身体 / 又不好 / 来 / 把 / 提走 / 他/。/\n",
  },
  {
    simplified: "打白条",
    pinyin: "dǎ bái tiáo",
  ...
  },
  {
    ...
    meaning:
      'Đảm bảo chắc chắn hoặc cam đoan về một điều gì đó sẽ xảy ra. Cũng gọi là "打保票".\n',
  ...
  },
  {
    ...
    explanationPinyin:
      "Jiùshì dì yī gè fāyán, dì yī gè jiǎnghuà. Yě shuō “dǎtóuzhèn”,“dǎtóu pào”.",
    meaning:
      "Là người phát biểu đầu tiên, nói trước. Cũng gọi là “打头阵”、“打头炮”.\n",
    examples:
      "今天我来打第一炮，希望能抛砖引玉。\n我来打第一炮，你们多给我加加油。",
    examplePinyin:
  ...
  },
  {
    ...
    arrange:
      "动笔/再/我/考试/的时候/常常/打/腹稿/。/\n发言/先/打好/腹稿，像/那样/别/上次/出洋相/再/。/",
  },
  {
    simplified: "打官腔",
    pinyin: "dǎ guān qiāng",
    explanation:
      "比喻利用规章、手续等来推托或责备，不解决实际问题。官腔，指旧 时官场中说的门面话。",
    explanationPinyin:
  ...
  },
  {
    ...
    meaning:
      "Đưa tranh chấp đến cơ quan tư pháp để hòa giải và phân xử đúng sai.",
  ...
  },
  {
    ...
    pinyin: "dǎ hēi qiāng",
    explanation:
      "比喻暗里使坏，乘人不备时突然开枪。比喻暗中对人进行突然袭击。也说“打冷枪”。",
    explanationPinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "Xiànzài zhǎo gōngzuò jiùshì dǎ lèi tái, yī duì yī de gōngpíng jìngzhēng.",
    exampleMeaning:
      "Tìm việc bây giờ giống như thi đấu đối kháng, phải cạnh tranh công bằng.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Tòngdǎ luò rù shuǐzhōng de gǒu. Bǐyù chèdǐ dǎkuǎ yǐjīng shīshìle de huàirén.",
    meaning: "Tấn công không khoan nhượng kẻ đã thất thế hoặc mất quyền lực.",
    examples:
      "从多年的斗争经验中认识到，落水狗还是要痛打的，因为它一旦上了岸，\n还会继续咬人。",
    examplePinyin:
  ...
  },
  {
    ...
    meaning:
      "Biểu thị việc cố ý che giấu hoặc giả vờ ngu ngốc để lừa người khác.\n",
    examples:
  ...
  },
  {
    ...
    pinyin: "dǎ mái fú",
    explanation:
      "原指军事用语，指预先隐蔽起来，待机行动。比喻隐瞒某些事实或不\n暴露情况。",
    explanationPinyin:
    ...
    arrange:
      "在结束 /喜欢/ 说评书的人/ 打埋伏，/ 的时候 / 吸引 / 每场 / 听众 / 都来听。",
  },
  {
    simplified: "打破铁饭碗",
    ...
    examplePinyin:
      "Xiànzài hěnduō qǐyè dōu dǎ pò tiě fàn wǎn, chóngxīn jìngzhēng shànggǎng.",
    exampleMeaning:
  ...
  },
  {
    ...
    examplePinyin:
      "Zhè cì qù shēnzhèn shíxí, wǒmen xiān pài yīgè rén qù dǎ qián zhàn.",
    exampleMeaning:
      "Lần này đi thực tập ở Thâm Quyến, chúng tôi sẽ cử người đi trước để chuẩn bị.",
  ...
  },
  {
    ...
    examplePinyin:
      "Wǒ yào bǎ jīngcháng dǎ xiǎo bàogào de rén dǎ rù shí bā céng dì yù.",
    exampleMeaning:
      "Tôi muốn tống những kẻ hay mách lẻo xuống tầng thứ mười tám của địa ngục!",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù zuò měimèng, zhǐ cóng hǎo de yī fāngmiàn qù kǎolǜ, dǎsuàn.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù lìyòng shíjiān shàng de chā shǔ lái shíxiàn mǒu zhǒng mùdì.",
    meaning:
      "Biểu thị việc tận dụng chênh lệch về thời gian để đạt được mục tiêu nào đó.\n",
    examples:
  ...
  },
  {
    ...
    explanation:
      "原指旧时官吏坐堂问事完了，打退堂鼓。比喻中途退缩，不想参加了。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bù huái hǎoyì dì bǎ biérén de yánxíng fǎnyìng gěi lǐngdǎo.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Gùyì bù shuō chū shìqíng de zhēnshí qíngkuàng ér yòu ràng rén nányǐ cāicè.",
  ...
  },
  {
    ...
    examplePinyin:
      "Xiǎoshíhòu, tā zuò huàishì de shíhòu, wǒ chángcháng gěi tā dǎ yǎn hù.",
    exampleMeaning:
      "Hồi nhỏ, mỗi khi nó làm chuyện xấu, tôi thường giúp nó che giấu.",
  ...
  },
  {
    ...
    meaning:
      "Cảnh báo hoặc nhắc nhở trước để đề phòng. Cũng gọi là “打防疫针”.",
    examples: "我妈妈爸爸经常给我打预防针。",
    examplePinyin: "Wǒ māmā bàba jīngcháng gěi wǒ dǎ yù fáng zhēn.",
    exampleMeaning:
      "Cha mẹ tôi thường nhắc nhở trước để tôi đề phòng những tình huống xấu.",
  ...
  },
  {
    ...
    explanation:
      "比喻为打开僵局而从中调解或提出折中办法。大事化小，小事化了。给别人一个台阶。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Méiyǒu nàme dà de nénglì què yìng yào zhuāng zuò yǒu zhèyàng de nénglì.",
    meaning:
      "Người không có khả năng lớn nhưng cố tình giả vờ có khả năng như vậy.\n",
    examples:
  ...
  },
  {
    ...
    exampleMeaning:
      "Nếu muốn trở thành người độc thân vui vẻ, có lẽ bạn còn thiếu chút gì đó.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ chōngdāng wèi nánnǚ hūnyīn huò qítā shìqíng qiānxiàndāqiáo de rén.",
    meaning:
  ...
  },
  {
    ...
    examplePinyin:
      "Nǐ bié ná wǒ dāng dǎng jiàn pái, wǒ hěn wúgū de, shénme yě bù zhīdào.",
    exampleMeaning:
      "Đừng lấy tôi làm “tấm khiên” để đỡ đòn, tôi vô can và chẳng biết gì cả.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Xiàng biérén sùshuō zìjǐ de tòngkǔ huò wěiqu. Yě shuō “tǔ kǔshuǐ”.",
    meaning:
  ...
  },
  {
    ...
    pinyin: "dǎo wèi kǒu",
    explanation:
      "指因为腻味而不想再吃。比喻讲话、文章或演出等没有意思，令人腻烦，使人不愿听，不愿看。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Biǎoshì kǒngjù, huò duǒguò zāinàn, dàn xiǎng xiǎng réng hàipà.",
    meaning:
  ...
  },
  {
    ...
    examplePinyin:
      "Shì bùshì yǒurén zài bèihòu diǎn guǐ huǒ, zhè jǐ gè xiǎohái, zěn huì gǎo pòhuài?",
    exampleMeaning:
      "Có phải ai đó đang ngấm ngầm xúi giục mấy đứa nhỏ phá phách không?",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù yǔ yùxiǎng de chūrù hěn dà, shìqíng chū hū yìliào, ràng rén chījīng.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhīchēng fáng liáng de zhùzǐ. Bǐyù qǐ zhǔyào zuòyòng de gǔgàn lìliàng.",
    meaning: "Trụ cột chống đỡ mái nhà, ám chỉ người giữ vai trò chủ chốt.",
    examples: "家里的顶梁柱突然没了，这日子可怎么过呀?\n\n",
    examplePinyin:
      "Jiālǐ de dǐng liáng zhù túrán méiliǎo, zhè rìzi kě zěnmeguò ya?",
    exampleMeaning:
      "Trụ cột gia đình đột ngột qua đời, không biết gia đình sẽ xoay sở thế nào.",
  ...
  },
  {
    ...
    examplePinyin:
      "Tā zhè cì yòu jìn jiānyù, zhēnshi gè èr jìn gōng de diǎnxíng lìzi. \n",
    exampleMeaning:
      "Anh ta lại vào tù lần nữa, đúng là một ví dụ điển hình của kẻ tái phạm.\n",
  ...
  },
  {
    ...
    explanationPinyin:
      "Xīnzhōng wéinán, shīwàng, zēnghèn huò bùmǎn shí yǎnjīng de biǎoqíng.",
    meaning:
      "Biểu cảm của đôi mắt khi cảm thấy khó xử, thất vọng, thù hận hoặc không hài lòng.",
    examples:
      "她对他的无知翻了个白眼，真是不知道该说什么。\n他很不满，在一旁翻白眼，但没人注意到他。",
    examplePinyin:
  ...
  },
  {
    ...
    arrange:
      "他 / 常常 /当不了大官，/那个人 / 因为他 / 犯牛脾气。\n又 /了 / 怎么了，/ 犯牛脾气/ 吧?",
  },
  {
    simplified: "放暗箭",
    pinyin: "fàng àn jiàn",
    explanation:
      "乘人不备，暗中射箭。比喻暗地里施展害人的\n手段。也说“射冷箭”、“放冷箭”。",
    explanationPinyin:
      "Chéng rén bù bèi, ànzhōng shèjiàn. Bǐyù àndìlǐ shīzhǎn hài rén de shǒuduàn. Yě shuō “shè lěngjiàn”,“fànglěngjiàn”.",
    meaning:
      "Lợi dụng lúc người khác không cảnh giác để hại họ. Cũng gọi là “射冷箭”、“放冷箭”.",
    examples: "有不少天才是被别人放出来的暗箭毁掉的。",
    examplePinyin:
      "Yǒu bù shǎo tiāncái shì bèi biérén fàng chūlái de àn jiàn huǐ diào de.",
    exampleMeaning:
      "Không ít tài năng bị hủy hoại bởi những mưu kế ngầm từ người khác.",
  ...
  },
  {
    ...
    exampleMeaning:
      "Vợ gọi anh ấy là kẻ vô dụng, nhưng anh ấy chẳng hề tức giận.",
  ...
  },
  {
    ...
    explanation:
      "歪曲或捏造事实向权力或检查机构控告别人。也指偷偷在上级面前诬告别人或说别人的坏话。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù zǒng shì gēn zài rén shēnhòu de rén, duō zhǐ háizǐ.",
  ...
  },
  {
    ...
    examplePinyin:
      "Wèi guān sān nián, tā guā liǎo bù shǎo dì pí, qúnzhòng yìjiàn hěn dà. ",
    exampleMeaning:
      "Làm quan ba năm, ông ta đã tham nhũng không ít, khiến dân chúng rất bất mãn.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù huài zhǔyì. Yě kě bǐyù chūrényìliào de hǎo diǎnzǐ.",
    meaning:
      "Ý tưởng xấu xa, nhưng cũng có thể ám chỉ ý tưởng bất ngờ mang lại hiệu quả tốt.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Míxìn chuánshuō zhōng de yīnyáng jiāojiè de guānkǒu, bǐyù xiōngxiǎn dì dìfāng.",
    meaning:
    ...
    examplePinyin:
      "Zhè jiùshì chuánshuō zhōng de guǐ mén guān, gǎn bù gǎn chuǎng?",
    exampleMeaning:
      "Đây chính là “cửa tử” trong truyền thuyết, dám bước qua không?",
  ...
  },
  {
    ...
    examplePinyin:
      "Lí tā yuǎn diǎn, tā shì yīkuài gǔn dāo ròu, hěn nán dǎfā de.",
    exampleMeaning:
      "Tránh xa anh ta ra, vì anh ấy như “kẻ lì lợm”, rất khó mà đuổi đi.",
  ...
  },
  {
    ...
    examplePinyin:
      "Zuò yìrén, yào yǒu jīngcháng bèi rén hè dào cǎi de zhǔnbèi.",
    exampleMeaning:
      "Nghề nghệ sĩ đòi hỏi phải sẵn sàng đối mặt với những lời chỉ trích từ khán giả.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ tiáotíng zhēngduān dì rén, tè zhǐ wú yuánzé de jìnxíng tiáojiě de rén.",
    meaning:
      "Chỉ người hòa giải, đặc biệt là người hòa giải không có nguyên tắc.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Cóngshì fēifǎ huódòng (rú zǒusī, fàndú, dǔbó děng) de chǎngsuǒ huò zǔzhī.",
    meaning:
      "Nơi hoặc tổ chức hoạt động phi pháp như buôn lậu, ma túy, cờ bạc.",
    examples: "很多国家有黑社会，包括北欧。",
    examplePinyin: "Hěnduō guójiā yǒu hēi shè huì, bāokuò běi'ōu.",
    exampleMeaning:
      "Nhiều quốc gia, kể cả Bắc Âu, vẫn tồn tại các băng đảng xã hội đen.",
  ...
  },
  {
    ...
    meaning:
      "Bữa tiệc có ý định hại khách, ám chỉ âm mưu gây tổn hại dưới vỏ bọc tiếp đãi.",
    examples: "今晚的饭局可能是鸿门宴，饭可不好吃啊。\n",
    examplePinyin:
      "Jīn wǎn de fànjú kěnéng shì hóng mén yàn, fàn kěbù hào chī a. ",
    exampleMeaning:
      "Bữa tiệc tối nay có lẽ là “bữa tiệc hại người,” đồ ăn chắc sẽ không ngon lành gì đâu.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Shòushāng hòu yíliú bìngzhèng, cháng zhǐ chǔlǐ bù gānjìng, liú máfan.",
    meaning:
      "Di chứng sau khi bị thương, thường chỉ việc xử lý không thấu triệt, để lại rắc rối.",
    examples:
      "他发热后怎么呆头呆脑的，是不是有了后遗症?\n 把猪圈全部彻底地消毒一遍，别留后遗症。",
    examplePinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "Yǒurén chángyòng hú lí jīng zhège cí lái fěibàng nǚrén, zhídào jīntiān, réngrán rúcǐ.",
    exampleMeaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù sàng'ǒu huò líyì de lǎorén zàicì liàn'ài. Hán bāoyì.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù xiǎng shíxiàn de hǎoshì luòkōng huò huànxiǎng pòmiè.",
    meaning:
  ...
  },
  {
    ...
    exampleMeaning:
      "Anh ấy đã làm đủ mọi chuyện xấu xa và trở thành một “ma vương”.",
  ...
  },
  {
    ...
    meaning:
      "Người luôn nhiệt tình giúp đỡ và làm việc tốt, giống như Lôi Phong.",
    examples: "他真是活雷锋，这样的人现在不多了。\n",
    examplePinyin: "Tā zhēnshi huó léi fēng, zhèyàng de rén xiànzài bù duōle.",
    exampleMeaning:
      "Anh ấy thực sự là một “Lôi Phong sống,” kiểu người tốt như vậy giờ rất hiếm.",
  ...
  },
  {
    ...
    pinyin: "huó pú sà",
    explanation:
      "菩萨，佛教中修行到一定程度、地位，仅次于佛的人。活菩萨是比喻心肠慈善或救人\n出苦难的人。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Dǎzhàng shí chōngfēng zài qián de rén. Bǐyù jījí lǐngtóu de rén.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Shuōhuà bù tòngkuài, huò shījiā yīdiǎn yālì, shuō chū yīdiǎn qíngkuàng.",
    meaning:
  ...
  },
  {
    ...
    meaning:
      "Cơm nửa sống nửa chín, ám chỉ việc làm không tốt từ đầu thì khó sửa sau này.",
    examples: "你冒冒失失的，尽做些夹生饭，最后还要我去收拾。",
    examplePinyin:
      "Nǐ mào mào shī shī de, jǐn zuò xiē jiā shēng fàn, zuìhòu hái yào wǒ qù shōushi.",
    exampleMeaning:
      "Anh làm mọi thứ quá vụng về, để lại việc dở dang cho tôi phải dọn dẹp.",
  ...
  },
  {
    ...
    exampleMeaning:
      "Trong những thành phố hoa lệ, vẫn có nhiều người ăn xin lang thang.",
  ...
  },
  {
    ...
    meaning:
      "Người kế thừa công việc của thế hệ trước, tiếp nối sự nghiệp gia đình.",
    examples: "年轻人要做社会主义的接班人。",
    examplePinyin: "Niánqīng rén yào zuò shèhuìzhǔyì de jiē bān rén.",
    exampleMeaning:
      "Người trẻ cần trở thành thế hệ kế thừa sự nghiệp xã hội chủ nghĩa.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù jǐnyào de, néng qǐ juédìng zuòyòng de huánjié huò shíjī.",
    meaning:
      "Ý chỉ giai đoạn hoặc thời điểm rất quan trọng, có thể quyết định.",
    examples:
  ...
  },
  {
    ...
    examplePinyin:
      "Tā jiē lǎo dǐ, ràng xǔduō rén de mìmì pùguāng. \n Jiē tā lǎo dǐ, tā kě yào fā jí de.",
    exampleMeaning:
  ...
  },
  {
    ...
    exampleMeaning:
      "Không có đấng cứu thế nào cả, mọi thứ đều phải dựa vào chính chúng ta.",
  ...
  },
  {
    ...
    meaning:
      "Tránh sang bên, nhường đường cho người khác, hoặc mất quyền lực, không còn tác dụng gì.",
    ...
    arrange:
      "他/再找一个/可挑不起/让他/靠边站，/更有魄力/的人/来吧。/这个大梁，",
  },
  {
    simplified: "靠山吃山",
    ...
    explanationPinyin:
      "Bǐyù zìjǐ suǒzài de dìfāng yǒu shénme tiáojiàn, jiù yīkào shénme tiáojiàn shēnghuó",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù méiyǒu shēngcún nénglì, chī fùmǔ lǎoběn de niánqīng rén.",
    meaning: "Thanh niên không có khả năng tự lập, sống dựa vào gia đình.",
    examples: "买房问题上，很多年轻人成了啃老族。",
    examplePinyin:
      "Mǎifáng wèntí shàng, hěn duō niánqīng rén chéngle kěn lǎo zú.",
    exampleMeaning:
      "Về chuyện mua nhà, nhiều người trẻ trở thành “ký sinh” phụ thuộc vào cha mẹ.",
  ...
  },
  {
    ...
    pinyin: "lā ɡuān xi",
    explanation:
      "指为了达到某种目的，跟关系疏远的人或单位联系、拉拢，建立某种关系。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Yǔ guānxi yībān de rén yǒuyì lāchě, gù biǎo qīnjìn. yòu zuò “tào jìnhu”",
    meaning:
      "Cố tình tạo mối quan hệ với người bình thường để tỏ ra thân thiết. Cũng gọi là “套近乎”.",
    examples:
  ...
  },
  {
    ...
    pinyin: "lā xià shuǐ",
    explanation:
      "使之卷入。把人拉入水中。比喻拉拢人一起去做坏事。也说“拖下水”。",
    explanationPinyin:
      'Shǐ zhī juǎnrù, bǎ rén lā rù shuǐ zhōng, bǐyù lālǒng rén yīqǐ qù zuò huàishì, yě shuō "tuō xià shuǐ"',
    meaning:
      "Kéo người khác vào; chỉ việc lôi kéo ai đó tham gia vào việc xấu. Cũng nói là “拖下水”.",
    examples:
      "你不要把这么一个单纯的人拉下水。\n 官员要清正廉洁，不要被行贿的人拉下水。",
    examplePinyin:
  ...
  },
  {
    ...
    meaning:
      "Nói những chuyện không liên quan đến công việc, trò chuyện phiếm.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Màrén dehuà, zhǐ méi pí méiliǎn de rén, liǎnpí hòu de rén.",
    ...
    arrange:
      "你/不要脸的/敢/“癞皮狗”，/偷我的/这条/东西。 \n 觉得/他/像/一样，/让人/很烦。/“癞皮狗”",
  },
  {
    simplified: "拦路虎",
    pinyin: "lán lù hǔ",
    explanation:
      "拦住道路的老虎，过去指拦路抢劫的匪徒。现在多用来比喻前进路 上的障碍或困难。",
    explanationPinyin:
  ...
  },
  {
    ...
    exampleMeaning:
      "“Lãng tử quay đầu là bờ” – việc anh ấy biết sửa sai thật đáng quý.",
  ...
  },
  {
    ...
    pinyin: "lǎo bǎ xì",
    explanation:
      "老旧的一套，多指没有改变的思想、方式、方法。把戏，杂技的节目。",
    explanationPinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "Tā shì yī zhǐ “lǎo hú li”, nǐ yào xiǎoxīn a. \n “lǎo hú li” yěyǒu shīsuàn de shíhòu.",
    exampleMeaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ chénjiù de yī tào. Duō zhǐ méiyǒu gǎibiàn de xí sú huò gōngzuò fāngfǎ.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Duō yòng lái jiè zhǐ shúhàn shìshì, míngzhé bǎoshēn de rén.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Méiyǒu yùliào dào, túrán. Yě shuō “lěng bù fáng”, “lěng gūdīng”.",
    meaning:
      'Không lường trước được, bất ngờ. Cũng có thể diễn đạt là "khôn lường", "không ngờ".',
    examples:
  ...
  },
  {
    ...
    examplePinyin:
      "Duì qúnzhòng tíchū de yìjiàn, cǎiqǔ lěnɡ chù lǐ de fāngfǎ, shì jí bù fù zérèn de tàidù.",
    exampleMeaning:
      "Dùng thái độ thờ ơ với ý kiến của người dân là vô cùng thiếu trách nhiệm.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Xìnggé juéjiàng, bù míng shìlǐ, zuò shì màngzhuàng de niánqīng rén.",
    meaning:
      "Ngựa non háu đá\n Người trẻ tuổi tính cách cứng đầu, không hiểu chuyện, làm việc bừa bãi.",
    examples:
      "你再冲在最前面，就成愣头青了，没看见大家只是起起哄吗?\n 他给年轻人忠告，千万别做愣头青。",
    examplePinyin:
  ...
  },
  {
    ...
    explanation:
      "借指取消资格、勒令停止。红牌是体育比赛中用来处罚严重犯规运动员的红色纸牌。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanation:
      "借指提出警告。黄牌是体育比赛中裁判用来警告违规运动员的黄色标志。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Fàngxià dànzi. Bǐyù diū xià yīng dānfù de gōngzuò, shuǎishǒu bù gàn.",
    meaning:
      "Buông bỏ trách nhiệm, từ chối làm công việc cần đảm nhận, bỏ mặc nhiệm vụ.",
    examples: "这里全靠你了，你得主持后面的工作，不能撂挑子。",
    examplePinyin:
      "Zhèlǐ quán kào nǐ le, nǐ dé zhǔchí hòumiàn de gōngzuò, bùnéng liào tiāo zi.",
    exampleMeaning:
  ...
  },
  {
    ...
    meaning:
      "Ẩn dụ cho việc nói và làm việc chưa trọn vẹn, còn thiếu sót, chưa đến nơi đến chốn.",
    examples:
      "道路施工留尾巴，会给车辆造成很大危险。\n 装修房子最好一步到位，别留尾巴。",
    examplePinyin:
  ...
  },
  {
    ...
    meaning:
      "Chỉ không thể hiện ra hết toàn bộ khả năng, cách làm của bạn, v.v.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ lùchū pòzhàn, bèi rén fà xiàn. Yě shuō “lòu mǎ jiǎo”.",
    meaning:
      'Chỉ việc để lộ sai sót, bị người khác phát hiện. Cũng gọi là "lộ chân ngựa".',
    examples:
      "我相信: 坏人总有露出狐狸尾巴的时候。\n 特务终于露出狐狸尾巴了，该收网了。",
    examplePinyin:
  ...
  },
  {
    ...
    meaning:
      "Phần đầu của đao hoặc gươm, ám chỉ tài năng vượt trội được bộc lộ.",
    examples: "平时他不怎么样，但关键时刻露了锋芒，令人刮目相看。",
    examplePinyin:
      "Píngshí tā bù zěnmeyàng, dàn guānjiàn shíkè lùle fēnɡ mánɡ, lìng rén guāmù xiàngkàn.",
    exampleMeaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Xiǎnlù chū yuánlái de xíngzhuàng, bǐyù bàolù chū yuánlái de miànmù.",
    ...
    exampleMeaning:
      "Chờ thêm chút nữa, gã xảo quyệt này sớm muộn cũng sẽ lộ bộ mặt thật.",
  ...
  },
  {
    ...
    exampleMeaning:
      "Nếu chưa suy nghĩ kỹ thì đừng nói bừa, coi chừng gây rắc rối.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù mǒu rén yánlùn huò xíngdòng bù hé qínglǐ, húchě huò húnào.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Lǚ: fǔmō. Bǐyù chùfàn yǒu quánshì de rén huò màozhe hěn dà de fēngxiǎn.",
    meaning:
      "捋: vuốt ve. Mạo hiểm đối đầu với người có quyền lực hoặc thế lực.",
    examples: "敢捋虎须的人，一定要大智大勇。",
    examplePinyin: "Gǎn luō hǔ xū de rén, yīdìng yào dàzhì dàyǒng.",
    exampleMeaning:
      "Người dám vuốt râu hổ chắc chắn phải cực kỳ thông minh và dũng cảm.",
  ...
  },
  {
    ...
    examplePinyin:
      "Wǒmen jīnglǐ tè xǐhuān “mǎ pì jīnɡ”. \n Nàgè “mǎ pì jīng” kě zhēn tǎoyàn.",
    exampleMeaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ shénme shìqíng dōu nǔlì zài qiánmiàn zuò de rén, nǔlì wéi zhǔrén xiàolì de rén.",
    meaning:
      "Chỉ người nỗ lực làm mọi việc ở phía trước, phục vụ cho người khác.",
    examples:
      "我们几个是我们总经理的“马前卒”，常打前哨。 \n 有事请吩咐，我甘当您的“马前卒”。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù shuōhuà huò zuòshì bùnéng zhǎngwò shìdàng de xiàndù",
  ...
  },
  {
    ...
    pinyin: "méi ɡuī ju",
    explanation:
      "比喻举止随便，不受常规或标准的限制。规矩: 画圆用的圆规和画直角或方形用的曲尺。",
    explanationPinyin:
      "Bǐyù jǔzhǐ suíbiàn, bù shòu chángguī huò biāozhǔn de xiànzhì",
  ...
  },
  {
    ...
    arrange:
      "像个/他/被/弄糊涂了，/到处/没头苍蝇，/乱撞。\n 别/镇定点，/像/脸。/没头苍蝇，/丢不丢",
  },
  {
    simplified: "没戏唱",
    pinyin: "méi xì chànɡ",
    explanation:
      "比喻没有其他办法可想了，无法使某事继续进行下去了。也说“没戏”。",
    explanationPinyin:
      'Bǐyù méiyǒu qítā bànfǎ kě xiǎng le, wúfǎ shǐ mǒu shì jìxù jìnxíng xiàqù le, yě shuō "méi xì"',
    meaning:
      "Không còn cách nào khác để tiếp tục, không thể tiến hành việc gì. Cũng nói là “没戏”.",
    examples:
  ...
  },
  {
    ...
    explanation:
      "比喻没有主见、没有固定看法的人。星: 指秤上标记斤、两、钱的小点子。",
    explanationPinyin:
  ...
  },
  {
    ...
    meaning:
      "Không biết quan sát, không có khả năng phân biệt đúng sai. Cũng nói là “没眼光”.",
    examples:
  ...
  },
  {
    ...
    meaning:
      "Chỉ người đối xử hòa nhã, chân thành, không có vẻ kiêu ngạo hay giả tạo.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Méiyǒu zǔdǎng de dōngxī, bǐyù xīnzhí kǒukuài, yǒu shénme shuō shénme",
  ...
  },
  {
    ...
    explanationPinyin:
      "Shǐ rén míhuò de quāntào, jìmóu, huò míhuò bù qīng de zhuàngkuàng",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù zuì shòu rén zhòngshì de wǎnbèi huò zhòngyào shìwù",
  ...
  },
  {
    ...
    meaning:
      "Xuất phát từ việc Tần Hối vu cáo Nguyên Phi, ý chỉ sự bịa đặt không có căn cứ.",
    examples:
      "你没有真凭实据，你对他的控告，是莫须有的。\n那些流言蜚语毫无根据，全是莫须有的。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Gōngzuò shí tuōyán shíjiān, yě fàn zhǐ gōngzuò lǎnsǎn tuōdá.",
    meaning:
  ...
  },
  {
    ...
    examplePinyin:
      "Zhēnshi mù tou rén yīgè, tā de yìsi, nǐ hái méi kàn chūlái ma?",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù xiàngmào chǒulòu, xiōng’è de nǚrén. Yèchā, fójiào zhǐ èguǐ.",
    meaning:
      "Người phụ nữ xấu xí và hung dữ, giống như dạ xoa trong Phật giáo.",
    examples: "再不睡，母夜叉要来了，专吃小孩。\n",
    examplePinyin: "Zàibu shuì, mǔ yè chā yào láile, zhuān chī xiǎohái.",
    exampleMeaning:
      "Nếu không ngủ sớm, “mẹ dạ xoa” sẽ đến và bắt những đứa trẻ hư.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù bǐcǐ yǒu yìjiàn ér hé bù lái huò gùyì wèinán duìfāng.",
    meaning:
      "Ví dụ như có ý kiến khác nhau và không hòa hợp với nhau hoặc cố ý gây khó dễ cho đối phương.",
    examples:
      "他们的友情经常因为小事而闹别扭，然而很快又和好如初。\n她和朋友最近闹别扭，互不说话。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Yīn cūxīn dàyì huò quēfá chángshí, jīngyàn ér fāshēng kěxiào de cuòwù.",
    meaning:
      "Do bất cẩn hoặc thiếu kiến thức, kinh nghiệm mà gây ra lỗi lầm đáng cười.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zuò yóuxì huò xìnòng rén, bǐyù yòng qīngshuài de tàidù duìdài rén huò shìqíng.",
    meaning:
      "Chơi đùa hoặc trêu chọc người khác, ví dụ như dùng thái độ nhẹ dạ đối với người hay việc.",
    examples:
      "孩子们在公园里嬉戏打闹，完全是闹着玩儿，笑声此起彼伏。\n我们只是闹着玩儿，并不是真的生气。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      'Bǐyù bājié huò tóukào yǒu quánshì de rén. Yě jiào "pá gāo zhī".',
    meaning:
      "Kẻ xu nịnh, bợ đỡ người có quyền lực. Cũng gọi là “爬高枝”:leo cành cao.",
    examples: "谁都想多少攀一点高枝，毕竟，竞争太激烈了，机会不多。\n",
    examplePinyin:
      "Shuí dōu xiǎng duōshao pān yī diǎn gāo zhī, bìjìng, jìngzhēng tài jīlièle, jīhuì bù duō.",
    exampleMeaning:
      "Ai cũng muốn leo lên “cành cao” để tìm cơ hội trong môi trường cạnh tranh khốc liệt.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Xìqǔ yòngyǔ, jí bànyǎn suícóng huò bīngzú děng bù chóng yào de juésè,\n xiànzài chángyòng lái bǐyù zài rén shǒuxià dǎzá.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù shòudào zǔ'ài huò zāo dào jùjué. Yě zhǐ shìqíng xíng bùtōng huò dá bù dào mùdì.",
    meaning:
  ...
  },
  {
    ...
    meaning:
      "Người làm việc hết sức, không tiếc mạng sống, cống hiến hết mình.",
    examples: "让他这个拼命三郎上场，或许可以反败为胜。",
    examplePinyin:
      "Ràng tā zhège pīnmìng sān láng shàng chǎng, huòxǔ kěyǐ fǎnbài wéishèng.",
  ...
  },
  {
    ...
    explanationPinyin:
      "yòng yányǔ huò xíngdòng dǎxiāo mǒu rén zuò mǒu shì de jījíxìng",
  ...
  },
  {
    ...
    explanationPinyin:
      "Dǎpò cóng wèi kāikěnguò de huāngwú zhuàngtài. Bǐyù shìqíng dì yī cì chūxiàn.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Xīncháng xiàng Púsà yīyàng ruǎn, jiàn bù dé rénjiā shòu kǔ lì.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù lìchǎng bù míngquè, zhàn zài zhōngjiān, xiàng liǎng fāngmiàn tǎohǎo de rén.",
    ...
    exampleMeaning:
      "Nhóm này nổi tiếng là những kẻ “đứng giữa,” không đứng về bên nào.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ hěn yǒu cáihuá, hěn yǒu nénglì, hěn yǒu qiántú de rén.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Lùchū tóu lái de niǎo yīdìng huì zāo dào qiāngjī. Bǐyù shǒuxiān dǎjí dàitóu de rén.",
    meaning:
      "Con chim ló đầu ra sẽ bị bắn. Biểu thị việc tấn công người dẫn đầu.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù lìchǎng bù jiāndìng, quēfá zhǔjiàn, zuǒyòu dòngyáo de rén.",
    meaning:
      "Người thiếu lập trường vững vàng, thiếu ý kiến riêng, dễ bị dao động.",
    examples: "在这个问题上，谁都要发表意见，不许做墙头草。\n",
    examplePinyin:
      "Zài zhège wèntí shàng, shuí dōu yào fābiǎo yìjiàn, bùxǔ zuò qiáng tóu cǎo.",
    exampleMeaning:
      "Trong chuyện này, ai cũng cần bày tỏ ý kiến, không được làm “cây cỏ đầu tường.”",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù cóng páng bāngqiāng, cóng páng zhù shì. Yě shuō “dǎ biān gǔ”.",
    meaning:
  ...
  },
  {
    ...
    exampleMeaning:
      "Bằng cấp đã trở thành “chìa khóa” mở ra cơ hội vào các công ty lớn.",
    arrange:
      "成了/敲门砖，/文凭/没有它，/一些/你/敲开/大公司的/就/很难/门/似乎",
  },
  {
    simplified: "翘尾巴",
    pinyin: "qiào wěi bā",
  ...
  },
  {
    ...
    exampleMeaning:
      "Cô chắc chắn muốn cưới anh ta? Anh ta là kẻ nghèo rớt mùng tơi đấy.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù shuōhuà, bànshì bù zhíjiéliǎodāng. Yě shuō “ràoquānzi”.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù zuì tònghèn ér jíyú chúdiào de rén. Cháng yǔ “yǎnzhōng dīng” liányòng.",
    meaning:
      "Chỉ người mà mình ghét nhất và muốn nhanh chóng loại bỏ. Thường đi kèm với “眼中钉”.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "tàidù hěn qiángyìng, shénme fāngfǎ jūn bùnéng shǐ qí gǎibiàn tàidù",
    meaning: "Chỉ thái độ cứng rắn trong thương lượng, không chịu thay đổi.",
    examples:
      "这家伙真是顽固，罚也罚了，好话也说了，他就是软硬不吃。\n这孩子，软硬不吃，真拿他没办法。",
    examplePinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "Bié kàn tā xiànzài chǔyú lièshì, shuō bu dìng huì yǒu sā shǒu jiǎn.",
    exampleMeaning:
  ...
  },
  {
    ...
    meaning:
      "Kẻ mang đến xui xẻo, thường ám chỉ người gây tai họa cho người khác.",
    examples: "别哭了，丧门神一个，真晦气。\n",
    examplePinyin: "Bié kūle, sāng mén shén yīge, zhēn huìqì.",
    exampleMeaning:
      "Đừng khóc nữa, trông cậu chẳng khác gì một “thần xui xẻo”, thật không may mắn chút nào.",
  ...
  },
  {
    ...
    exampleMeaning:
      "Những công trình trái phép mọc lên trong khu phố khiến cảnh quan thật xấu xí.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù sǒngyǒng gǔdòng, tiǎo qǐ shìduān; shāndòng biérén nào shì.",
    ...
    exampleMeaning:
      "Tình hình đã căng thẳng mà anh ấy còn xúi giục, khiến mọi chuyện tệ hơn.",
  ...
  },
  {
    ...
    examples:
      "我们厂的产品质量要想再上一个新台阶，我们就必须集中力量进行技术攻关。\n",
    examplePinyin:
    ...
    exampleMeaning:
      "Nếu muốn nâng cao chất lượng sản phẩm, chúng tôi phải tập trung phát triển công nghệ.",
    arrange:
      "质量/产品/我们厂的/新台阶，/一个/上/力量/要想/再/必须/攻关/技术/我们/进行/集中",
  },
  {
    simplified: "射冷箭",
  ...
  },
  {
    ...
    explanationPinyin:
      "Xíngróng zuòshì jí wéi yǐnmì, biérén yīdiǎn yě bù zhīdào.",
    meaning: "Làm việc kín đáo đến mức không ai biết.",
    examples: "我们的主力部队神不知，鬼不觉地，摸到了敌人的老窝。\n",
    examplePinyin:
      "Wǒmen de zhǔlì bùduì shén bù zhī, guǐ bù jué de, mō dàole dírén de lǎowō.",
    exampleMeaning:
      "Đội chủ lực của chúng tôi đã âm thầm tiến vào căn cứ địch mà không ai hay biết.",
  ...
  },
  {
    ...
    examplePinyin:
      "Qǐng zhèn shàng de shén suàn zǐ suàn suàn ba, jìnlái yǒu méiyǒu hǎo yùnqì.",
    exampleMeaning:
      "Hãy nhờ thầy “神算子” của thị trấn tính xem liệu sắp tới có vận may nào không.",
  ...
  },
  {
    ...
    pinyin: "shì jīn shí",
    explanation:
      "一种矿石，非常坚硬，可以用来检验黄金的成色。比喻精确可靠的检\n验方法或标准。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ bù dǒngdé liánxì shíjì, zhǐ zhīdào kěn shūběn de rén.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      'Biǎoyǎn móshù, zájì, bǐyù shǐyòng mēng piàn rén de shǒuduàn.Yě shuō "wán bǎ xì"',
    meaning:
      "Biểu diễn ảo thuật, xiếc; ví dụ như sử dụng thủ đoạn lừa gạt. Cũng nói là 也说“玩把戏”.",
    examples:
      "在街头表演时，他总能耍把戏，吸引了不少观众围观。\n他在舞台上耍把戏，观众们都看得很开心。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Yòng bǐ xiě dōngxī, bǐyù cóngshì wénmì gōngzuò huò xiě wénzhāng.",
    meaning:
      "Viết văn, giấy tờ; ví dụ như làm công việc văn phòng hoặc viết bài.",
    examples:
      "每当写报告时，他就开始耍笔杆，充分展示自己的文采。\n她在大学时耍笔杆，发表了很多优秀的文章。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ shǐyòng shǒuduàn shǐ zìjǐ shěng lì huò miǎn fù zérèn.",
    meaning:
      "Chỉ dùng phương pháp để làm cho bản thân đỡ mệt hoặc không chịu trách nhiệm.",
    examples:
      "他习惯性耍滑头，从不真正参与团队合作，总是想省力。\n他在工作中耍滑头，试图逃避责任。",
    examplePinyin:
  ...
  },
  {
    ...
    meaning:
      "Ví dụ như sử dụng những hành vi xấu xa, lừa đảo hoặc quấy rối phụ nữ.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ gùyì biǎoxiàn chū shǐ rén jìngwèi de shēngshì huò qìpài.",
    meaning:
      "Cố ý thể hiện ra sức mạnh hoặc phong thái khiến người khác kính nể.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù xǐhuān biérén shùnyìng zìjǐ de bǐngxìng, píqì, yìyuàn de rén.",
    meaning:
      "Biểu thị người thích người khác làm theo tính cách, tâm trạng và ý muốn của mình.\n",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      'zhǐ shuōhuà bù liúshén ér xièlùle jīmì huò fāshēng cuòwù. Yě shuō "shuō zǒu zuǐ".',
    meaning:
      "Nói không cẩn thận, lỡ miệng tiết lộ bí mật hoặc sai sót. Cũng nói là “说走嘴”.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Yībān zhǐ shǔyú fùnǚ zìjǐ de cáichǎn, yóu zhǐ juéduì yóu tā zhīpèi de cáichǎn.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù wèi biérén de lìyì bēnzǒu xiàoláo huò fèngchéng chuīpěng.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Xìbān zhōng de zhǔyào yǎnyuán, jiè zhǐ jítǐ zhōng de gǔgàn.",
    meaning:
      "Diễn viên chính trong gánh hát, ám chỉ người nòng cốt trong tập thể.",
    ...
    arrange:
      "人家/可是/他们/公司/的/台柱子，你/想/把/李红/挖走？我/看/那是/不可能/的/。/",
  },
  {
    simplified: "摊底牌",
    pinyin: "tān dǐ pái",
    ...
    arrange:
      "我/真/不知/他/什么意思，他/不肯/摊底牌/。/\n大家/又/很/不自在/了，真/等到/摊底牌/的/时候/。/",
  },
  {
    simplified: "探口气",
    pinyin: "tàn kǒu qì",
    explanation:
      "指设法引出对方的话，探听他对某人某事的态度或看法。也说“探口风”。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù hùxiāng tuīwěi, bǎ yīnggāi jiějué de shìqíng tuī gěi biérén.",
    meaning:
  ...
  },
  {
    ...
    exampleMeaning:
      "Chỉ cần tìm vài người chịu tội thay là mọi chuyện được giải quyết.",
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù chùfàn lìhài huò bù jiǎng dàolǐ de rén, huì rě chū máfan huò zāodào bàofù",
    meaning:
      "Chạm trán người có quyền lực hoặc hành động không hợp lý, sẽ gây rắc rối hoặc bị trả thù.",
    examples: "她可是有名的泼妇，你别去捅这个马蜂窝。\n",
    examplePinyin:
      "Tā kěshì yǒumíng de pōfù, nǐ bié qù tǒng zhège mǎ fēng wō. \n",
    exampleMeaning:
      "Cô ấy là người nổi tiếng hung dữ, bạn đừng có đụng vào vấn đề này. \n",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù qiānzhì, zǔnáo biérén huò bié de shìwù, shǐ qí bùdé qiánjìn.",
    meaning:
      "Ý chỉ việc cản trở, làm cho người khác hoặc sự vật không thể tiến lên.",
    examples:
  ...
  },
  {
    ...
    examplePinyin:
      "Yòu lái wā qiáng jiǎo le, kuài zǒu, bùrán wǒ kě yào fān liǎn le.",
    exampleMeaning:
      'Lại đến "đào góc tường" rồi, đi ngay, nếu không tôi sẽ trở mặt đấy.',
  ...
  },
  {
    ...
    examplePinyin:
      "Tā kě shì duōnián de wáng lǎo wǔ, kuài sìshí le, lián nǚ péngyǒu dōu méiyǒu.",
    exampleMeaning:
      "Anh ấy là kẻ độc thân lâu năm, đã gần 40 tuổi mà vẫn chưa có bạn gái.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Yǒngyuǎn tián bù mǎn de dòng. Bǐyù yǒngyuǎn mǎnzú bùliǎo de yùwàng hé yāoqiú.",
    ...
    exampleMeaning:
      "Đừng đưa tiền cho anh ta nữa, anh ta giống như “hố không đáy”, không bao giờ biết đủ.",
  ...
  },
  {
    ...
    meaning:
      "Chiếc mũ quan thời xưa, ám chỉ địa vị hoặc chức quan của một người.",
    examples: "他关心的不是群众的利益，而是自己头顶的乌纱帽。",
    examplePinyin:
      "Tā guānxīn de bùshì qúnzhòng de lìyì, ér shì zìjǐ tóudǐng de wū shā mào.",
    exampleMeaning:
  ...
  },
  {
    ...
    meaning:
      "Ở trong tình huống khó xử, không thoát ra được. Cũng nói là “下不了台”.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "yòng bù réndào de, hěndú de fāngfǎ, shǒuduàn duìdài rén héshì",
    meaning:
      "Dùng phương pháp tàn nhẫn, không nhân đạo để đối xử với người hoặc một việc nào đó.",
    examples:
      "是谁向那只流浪狗下了毒手，杀死了它? \n在绝望的时候，他对自己的亲人下起了毒手。 \n敌人早晚要下毒手，我们要做好最坏的打算。",
    examplePinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "Nǐ dé xià diǎn gōng fu, bǎ zǒngjié bàogào xiě hǎo, shàngcì de tài zāogāo le.",
    exampleMeaning:
      "Anh cần bỏ công sức hơn nữa để hoàn thiện báo cáo, lần trước viết quá tệ.",
  ...
  },
  {
    ...
    exampleMeaning:
      "Vào thập niên 80, rất nhiều người bỏ nhà nước để ra ngoài làm ăn.",
  ...
  },
  {
    ...
    meaning:
      "Ban đầu thể hiện sức mạnh hoặc uy thế để khiến đối phương phải e dè.",
    examples:
      "他刚来公司就给了大家一个下马威，让人不敢反抗。\n敢和我对着干? 我非得给他一个下马威。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù tuōlí xiànshí shēnghuó de wényìjiā huò zhīshì fènzǐ de xiǎo tiāndì.",
    meaning:
      "Ám chỉ người xa rời thực tế, chỉ sống trong thế giới nhỏ của riêng mình.",
    examples: "大学就是一座象牙塔，想进去，不容易。\n",
    examplePinyin: "Dàxué jiùshì yī zuò xiàng yá tǎ, xiǎng jìnqù, bù róngyì.",
    exampleMeaning:
      "Đại học giống như một tòa tháp ngà, vào được thì không hề dễ.",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù liánxù jìnxíng de shìqíng zhōng chā rù xiǎo tèshū qíngkuàng.",
    meaning:
      "Ý chỉ một chuỗi tình huống đặc thù liên tục chen ngang vào sự việc.",
    examples:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zài xiǎo shìqíng shàng biǎoxiàn chūlái de cōngmíng (duō hán biǎnyì).",
    meaning:
      "Thể hiện sự thông minh trong những việc nhỏ (thường mang nghĩa tiêu cực).",
    examples:
  ...
  },
  {
    ...
    pinyin: "xiǎo ér kē",
    explanation:
      "本指医院中专门诊治儿童疾病的部门。比喻不重要的工作部门或事情。",
    explanationPinyin:
    ...
    examples:
      "工会是代表广大职工利益的群众组织，它的作用是很大的，你把工会看成小儿科是不对的。\n 幼儿园老师，也需要有专业的知识。你把它看成小儿科，认为人人都可以做，这是外行话。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ tuántǐ zhōng yīxiē niánjì jiào xiǎo, zīlì jiào qiǎn de rényuán.",
    meaning:
  ...
  },
  {
    ...
    examplePinyin:
      "xiǎo wáng chéngle tā de yǎn zhōng dīng, yīxīn xiǎng bá diào.",
    exampleMeaning:
      "Tiểu Vương như cái gai trong mắt hắn, chỉ muốn loại bỏ cho bằng được.",
  ...
  },
  {
    ...
    pinyin: "yáo qián shù",
    explanation:
      "神话中的一种宝树，一摇晃就会有很多钱落下来。比喻借以获取钱 财的人或物。",
    explanationPinyin:
  ...
  },
  {
    ...
    pinyin: "yī bǎ shǒu",
    explanation:
      "指非常能干的人。也说“一把好手”。单位或组织的主要负责人。指带头人。",
    explanationPinyin:
  ...
  },
  {
    ...
    meaning:
      "Diễn tả sự thay đổi hoàn toàn, trái ngược với trạng thái trước đó.",
    examples:
  ...
  },
  {
    ...
    pinyin: "yī biān dǎo",
    explanation:
      "一边倒: 朝一个方向倾斜。比喻人的立场、思想、情绪等都倾向一个方面。也\n说“一面倒”。",
    explanationPinyin:
    ...
    examplePinyin:
      "Zhè chǎng bǐsài de jiéguǒ shì yī biān dǎo, wánquán méiyǒu xuánniàn.\n",
    exampleMeaning:
      "Kết quả của trận đấu này hoàn toàn nghiêng về một bên, không hề có gì bất ngờ.\n",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù yòng huàyī de bànfǎ chǔlǐ qíngkuàng huò xìngzhì bùtóng de shìwù.",
    meaning:
      "Nói về việc áp dụng cùng một phương pháp cho những tình huống khác nhau.",
    examples:
      "对待不同情况不能一刀切，应该灵活处理。\n工作上不搞一刀切，但要协调一致。",
    examplePinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Gōujié zài yīqǐ, duì mǒu shì cǎiqǔ tóngyàng de tàidù hé zhǔzhāng",
  ...
  },
  {
    ...
    examplePinyin:
      "Tā yī gè jìnr de liànxí, zhōngyú tōngguò le kǎoshì.\nTā jí de yī gè jìnr de tíxǐng wǒ.\n",
    exampleMeaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù shēngchǎn chéngxù huò gōngzuò shàng de jǐnmì liánxì hé pèihé.",
    meaning:
      "Chỉ sự liên kết chặt chẽ trong quy trình sản xuất hoặc công việc.",
    examples:
      "这家酒店提供一条龙的服务，从接送到住宿都非常方便。\n机动车税收将实行“一条龙”管理。",
    examplePinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "hái méi qǐchuáng, jiù bèi mà le yī tōng, zhēn shì yī tóu wù shuǐ.",
    exampleMeaning:
      "Vừa thức dậy đã bị mắng, tôi chẳng hiểu chuyện gì đang xảy ra.",
  ...
  },
  {
    ...
    arrange:
      "一团糟/他的/房间里/，/根本/找不到/东西/。/\n一团糟/学校/网站/简直是/，/太难/登录/上去了/！/",
  },
  {
    simplified: "一窝蜂",
    pinyin: "yī wō fēnɡ",
    explanation:
      "一窝蜂: 比喻许多人乱哄哄地同时说话或行动。也比喻混乱的局面或烦乱的\n心情。",
    explanationPinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "Tā zuò shìqíng zǒng shì yī zhèn fēng, méi shénme chángjiǔ de jìhuà.\n",
    exampleMeaning:
      "Anh ta làm việc như một cơn gió thoảng, không có kế hoạch dài hạn nào.\n",
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù jiānqiáng bù qū de rén huò qìgài. Yě bǐyù jiānjù de rènwù.",
    meaning:
  ...
  },
  {
    ...
    meaning:
      "Đó là một phép ẩn dụ cho việc miễn cưỡng làm điều không muốn làm.",
    examples:
  ...
  },
  {
    ...
    exampleMeaning:
      "Bạn đúng là người chỉ biết hùa theo, chẳng có chút thú vị nào.",
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù shùshuō mǒu shì jùtǐ, huó línghuó xiàn, fǎngfú zhēn yǒu qí shì",
    meaning:
      "Khi kể về một chuyện gì đó, có cách miêu tả cụ thể, sinh động, như thể có thật.",
    ...
    arrange:
      "有鼻子有眼/他说/他/昨天/撞见鬼了/，/说得/，/我/看/他/是/在/自己/吓/自己/。/",
  },
  {
    simplified: "有分寸",
    pinyin: "yǒu fēn cùn",
  ...
  },
  {
    ...
    explanation:
      "也说“有好戏”。指事情越来越复杂，矛盾越来越尖锐或角逐越来越激烈。",
    explanationPinyin:
  ...
  },
  {
    ...
    meaning:
      "Có lai lịch, xuất thân (thường chỉ về năng lực hoặc bối cảnh của người khác).",
    examples: "不管来头有多大，犯了法，就应该依法得到惩处。 \n",
    examplePinyin:
      "Bùguǎn lái tou yǒu duō dà, fànle fǎ, jiù yīnggāi yīfǎ dédào chéngchǔ. \n",
    exampleMeaning:
      "Dù có thân thế lớn đến đâu, nếu phạm tội, cũng phải bị xử lý theo pháp luật. \n",
  ...
  },
  {
    ...
    explanation:
      "也说“有几把刷子”、“有两手”、“有两下子”。比喻有一些本领、本事、技能。",
    explanationPinyin:
  ...
  },
  {
    ...
    examples:
      "找赞助的工作已经有眉目了，确定了赞助商之后，我们就可以大刀阔斧地干了。 \n",
    examplePinyin:
    ...
    arrange:
      "有眉目/找/赞助的/工作/已经/，/确定了/赞助商/之后/，/我们/就可以/大刀阔斧地/干了/。/\n",
  },
  {
    simplified: "有门道",
    pinyin: "yǒu mén dào",
    ...
    explanationPinyin:
      "bǐyù zuòshì dǒng dé juéqiào, yǒu bànfǎ, yě shuō yǒu ménlù",
  ...
  },
  {
    ...
    explanationPinyin:
      "bǐyù yǒu lüèwēi xiǎnlù chūlái de mǒu zhǒng qūshì huò qíngkuàng",
    ...
    arrange:
      "有苗头/孩子/最近的/表现/，/让我/觉得/他/有/早恋的/，/这可/怎么办呢/？/\n",
  },
  {
    simplified: "有谱儿",
    pinyin: "yǒu pǔr",
  ...
  },
  {
    ...
    explanationPinyin:
      "zhǐ kāishǐ hǎozhuǎn (duō zhǐ huànsàn de gōngzuò huò yánzhòng de jíbìng)",
    meaning:
      "Bắt đầu có sự cải thiện (thường chỉ công việc kém hoặc bệnh nặng).",
    examples:
  ...
  },
  {
    ...
    exampleMeaning:
      "Những gì anh ấy nói có quá nhiều điều không đúng, bạn không thể hoàn toàn tin tưởng. \n",
  ...
  },
  {
    ...
    examplePinyin:
      "Kàn tāmen yǒu yī tǎ méi yī tǎ de liáo zhe, kěndìng xīn bù zài yān.",
    exampleMeaning:
      "Nhìn họ nói chuyện hời hợt như vậy, rõ ràng là không tập trung.",
  ...
  },
  {
    ...
    meaning:
      "Tạo dựng chỗ đứng vững chắc\n Nghĩa là giành được địa vị ổn định.",
    examples: "新到这家公司，还没站稳脚跟，处处得小心。\n ",
    examplePinyin:
      "Xīn dào zhè jiā gōngsī, hái méi zhàn wěn jiǎo gēn, chùchù děi xiǎoxīn.\n ",
    exampleMeaning:
      "Mới đến công ty này, vẫn chưa có chỗ đứng vững chắc, chỗ nào cũng phải cẩn thận.\n ",
  ...
  },
  {
    ...
    explanationPinyin:
      "Zhǐ dédàole xiǎo de hǎochù què zāoshòule hěn dà de sǔnshī.",
    meaning:
      "Tham hạt vừng bỏ quả dưa hấu\n Chỉ việc nhận được lợi ích nhỏ nhưng lại chịu thiệt hại lớn.",
    examples:
  ...
  },
  {
    ...
    examplePinyin:
      "Tāmen shì shénme yìsi? Wǒ xiànzài shì zhàng èr hé shàng mō bù zháo tóu nǎo.",
    exampleMeaning:
      "Tôi chẳng hiểu họ đang nói gì, cảm giác như thầy tu không biết đọc kinh vậy.",
  ...
  },
  {
    ...
    meaning:
      "Gương soi yêu quái, ví với công cụ phơi bày sự xấu xa hoặc các hành vi tội lỗi.",
    examples: "邪恶最怕照妖镜，一照就现形了。\n",
    examplePinyin: "xié'è zuì pà zhào yāo jìng, yī zhào jiù xiàn xíng le.",
    exampleMeaning:
      "Cái ác sợ nhất là “gương soi yêu,” chiếu vào là lộ rõ ngay bản chất.",
  ...
  },
  {
    ...
    explanation:
      "睁一只眼闭一只眼: 比喻对事物(多指不好的)看见了，装出没看见的样子，不 去过问。",
    explanationPinyin:
  ...
  },
  {
    ...
    examplePinyin:
      "wǒmen yào lì zhēng shàng yóu, yòu kuài yòu hǎo de wánchéng rènwù.",
    exampleMeaning:
      "Chúng ta cần nỗ lực vươn lên và hoàn thành nhiệm vụ một cách nhanh chóng và hiệu quả.",
    arrange:
      "任务 / 完成 / 地 / 好 / 又 / 快 / 又 / 上游 / 力争 / 要 / 我们 / 。",
  },
  {
    simplified: "智多星",
    pinyin: "zhì duō xīnɡ",
    explanation:
      "原为古典小说《水浒传》中梁山军师吴用的绰号，\n现泛指聪明机智、计谋多的人。",
    explanationPinyin:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù xìngqíng zhí shuǎng, yǒu shénme shuō shénme; yě zhǐ xìngqíng zhí shuǎng de rén.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      'Bǐyù wèile biǎomiàn hǎokàn ér zuò mǒu shì. Yě shuō "zhuàng ménmiàn".',
    meaning:
    ...
    examplePinyin:
      "Tā mǎi le jǐ kē shèngdàn shù, zhuāng mén miàn, hōng hōng xiǎohái.",
    exampleMeaning:
      "Anh ấy mua vài cây thông Noel để trang trí và làm vui lòng trẻ em.",
  ...
  },
  {
    ...
    examplePinyin:
      "Zhè jǐ ge dà pái chūxí wǎnhuì, bùguò shì zǒu guò chǎng, zhuàn diǎn qián ér yǐ.",
    exampleMeaning:
      "Những người nổi tiếng tham gia buổi tiệc này cũng chỉ để “diễn qua loa” và kiếm chút tiền.",
    arrange:
      "而已 / 钱 / 赚点 / 走过场 / 是 / 不过 / 晚会 / 出席 / 大牌 / 几个 / 这 / 。",
  },
  {
    simplified: "走后门",
    pinyin: "zǒu hòu mén",
    ...
    explanationPinyin:
      "Bǐyù tōngguò fēifǎ de bù zhèngdàng guānxì lái dádào mǒu zhǒng mùdì.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Bǐyù lìyòng mǒu zhǒng lòudòng, jìnxíng duì zìjǐ yǒulì de huódòng.",
    meaning:
  ...
  },
  {
    ...
    explanationPinyin:
      "Sǐhútòng zhǐ zǒu bùtōng de xiǎo jiēdào, bǐyù zǒu dào jué lùshàngle.",
    meaning:
      "Ngõ cụt là con đường nhỏ không lối thoát, ngụ ý cho việc đã đi đến đường cùng.",
    examples: "他的研究进入了误区，就像钻进了死胡同，出不来了。\n",
    examplePinyin:
      "Tā de yánjiū jìnrùle wùqū, jiù xiàng zuān jìnle sǐ hú tòng, chū bù láile. \n",
    exampleMeaning:
  ...
  },
  {
    ...
    explanation:
      "原为讽刺乡村私塾先生清冷职位的话。后来比喻不受重视，遭到冷遇。",
    explanationPinyin:
    ...
    examplePinyin:
      "Jíbiàn shì shìjiè zúqiú xiānshēng, yě yǒu zuò lěng bǎn dèng de shíhòu.\n ",
    exampleMeaning:
      "Ngay cả cầu thủ xuất sắc nhất thế giới cũng có lúc ngồi dự bị.\n ",
  ...
  },
  {
    ...
    examplePinyin:
      "Tā zài bǐsài zhōng zuò le shǒu jiǎo, bèi cáipàn zhuā zhù le.\n\n",
    exampleMeaning:
      "Anh ta gian lận trong cuộc thi và bị trọng tài phát hiện.\n\n",
  ...
  },
  {
    ...
    exampleMeaning:
      "Anh ấy tin tưởng tôi nhất, tôi đã trở thành cánh tay phải của anh ấy.",
...
function stringToSlug(str) {
  // remove accents
  var from =
      "ɡǎāàáãảạăằắẳẵặâầấẩẫậēěèéẻẽẹêềếểễệđùúủũụưừứửữựōǒòóỏõọôồốổỗộơờớởỡợīìíỉĩịǐäëïîöüûñçýỳỹỵỷ",
    to =
      "gaaaaaaaaaaaaaaaaaaaeeeeeeeeeeeeeduuuuuuuuuuuoooooooooooooooooooiiiiiiiaeiiouuncyyyyy";
  ...
  const examples = item.examples
    ...
    .map((example, index) => {
      ...
      if (!exampleMeaning?.[index]) {
        ...
        console.log(
          `cột ${dataIndex + 2} - có ${index} nghĩa tiếng việt < số ví dụ`
        );
      }
      return {
        chinese: example,
